...
import {
  ...
  render,
  withinExtentAndZ
} from "./chunk-33EFHZUL.js";
import {
  Source_default,
  Vector_default,
  loadFeaturesXhr
} from "./chunk-HK2HWBP5.js";
import {
  ImageState_default,
  Image_default,
  decode
} from "./chunk-DLPFPPHG.js";
import {
  TileQueue_default
...
import {
  Feature_default
} from "./chunk-JH5VNBK3.js";
import {
  Point_default,
  create
} from "./chunk-3EQ6ETJP.js";
import "./chunk-E3EOWQ7J.js";
import {
  Disposable_default,
  EventType_default,
  Event_default,
...
addDecoder(
  34887,
  () => import("./lerc-MVQOK7X3.js").then(async (m) => {
    await m.zstd.init();
    return m;
  }).then((m) => m.default)
);
  ...
  constructor(size = defaultPoolSize, createWorker2) {
    ...
    if (size) {
      this._awaitingDecoder = createWorker2 ? Promise.resolve(createWorker2) : new Promise((resolve) => {
        import("./decoder-GPPPBIBS.js").then((module) => {
